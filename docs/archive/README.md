...
| 归档文档 | 当前替代文档 |
|---|---|
| `CurrentAssessmentAndPlan.md` | `../roadmap/roadmap.md`、`../architecture/overview.md`、`../testing/acceptance.md` |
| `MilestoneChecklist.md` | `../testing/acceptance.md`、`../roadmap/roadmap.md` |
