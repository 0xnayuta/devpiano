...
> 状态：已完成。  
> 当前迭代入口：[`../roadmap/current-iteration.md`](../roadmap/current-iteration.md)。
...
- [x] 将当前架构文档移动到 [`architecture/overview.md`](../architecture/overview.md)。
- [x] 将旧代码迁移说明移动到 [`architecture/legacy-migration.md`](../architecture/legacy-migration.md)。
- [x] 将快速开始文档移动到 [`getting-started/quickstart.md`](../getting-started/quickstart.md)。
- [x] 将 WSL / Windows / MSVC 工作流文档移动到 [`development/wsl-windows-msvc-workflow.md`](../development/wsl-windows-msvc-workflow.md)。
- [x] 将路线图移动到 [`roadmap/roadmap.md`](../roadmap/roadmap.md)。
- [x] 将当前迭代文档移动到 [`roadmap/current-iteration.md`](../roadmap/current-iteration.md)。
- [x] 为主要目录补充轻量 README。
- [x] 新增 [`index/doc-map.md`](../index/doc-map.md) 作为文档地图。
...
- [x] [`docs/README.md`](../README.md) 能说明新的目录职责和推荐阅读顺序。
- [x] 各主要目录有轻量 README 入口。
- [x] 现行主文档已经移动到目标目录。
- [x] [`archive/README.md`](README.md) 标明旧文档被哪些新文档替代。
