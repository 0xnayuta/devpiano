...
详见：[`../testing/phase2-keyboard-mapping.md`](../testing/phase2-keyboard-mapping.md)。
...
- 布局 Preset / 导入导出 / 重命名 / 删除 / 启动恢复核心能力已完成，后续主要是低优先级体验增强。
...
1. 补齐默认布局全量回归。
2. 持续按布局 Preset 专项测试做回归，必要时补充冲突提示等低优先级体验增强。
3. 持续验证焦点、输入法、修饰键等边界。
4. 后续再完善图形化布局编辑器等非近期能力。
