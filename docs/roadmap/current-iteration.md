...
2. **Phase 23-B：同音三弦立体声非对称微失谐与声相展开 [排期中]**；
3. **Phase 23-C：云杉木音板低通截止与木质腔体共鸣峰配平 [排期中]**；
4. **Phase 23-D：起音瞬态裂音与低音纵波微调 [排期中]**。

---

## Phase 23-A：动态琴槌非线性刚度与击弦点几何陷波 [已完成]

### 子任务排期（Phase 23-A）

- [x] **分析现有琴槌模型与物理文献/`../piano` 实现**
- [x] **实现动态毛毡硬度、动态接触时间与速度相关高频滚降指数**
- [x] **实现精确击弦点几何梳状陷波与 88 键基底幂次衰减**
