...
P0/P1 线程安全审计修复（`PLUG-001`、`REC-005`、`REC-002`、`REC-003`）：
- PluginHost 添加 `jassert(isMessageThread())` 断言 + 文档化线程安全契约
- PluginOfflineRenderer 文档化独立实例线程隔离
- RecordingSessionController 异步 lambda alive-flag 防 use-after-free
- RecordingEngine preset 变更独立队列避免向量并发写

详见 [`../audit/code-quality-audit-2026-07-20.md`](../audit/code-quality-audit-2026-07-20.md)。
