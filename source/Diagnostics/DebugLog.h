...
#define DP_DEBUG_LOG(message)                                                                                          \
    do {                                                                                                               \
        devpiano::diagnostics::logInfo((message));                                                                     \
    } while (false)
#else
#define DP_DEBUG_LOG(message)                                                                                          \
    do {                                                                                                               \
...
#define DP_TRACE_MIDI(message, stage)                                                                                  \
    do {                                                                                                               \
        devpiano::diagnostics::traceMidi((message), (stage));                                                          \
    } while (false)
