...
findUserLayoutFileById(const juce::String& layoutId) {
    ...
    for (const auto& entry :
         dir.findChildFiles(juce::File::TypesOfFileToFind::findFiles, false, "*.freepiano.layout")) {
...
void LayoutFlowSupport::runLayoutFileChooser(const juce::String& title, const juce::File& startingDir,
...
void LayoutFlowSupport::runLayoutRenameDialog(const juce::String& layoutId, const juce::File& /*file*/,
    ...
    renameWindow->enterModalState(
        true, juce::ModalCallbackFunction::create([safeOwner, safeWindow, layoutId](int result) {
...
void LayoutFlowSupport::runLayoutDeleteDialog(const juce::String& layoutId, const juce::File& file,
