...
[[nodiscard]] std::optional<devpiano::core::KeyboardLayout> loadLayoutPreset(const juce::File& path);

[[nodiscard]] bool saveLayoutPreset(const devpiano::core::KeyboardLayout& layout, const juce::File& path);
} // namespace devpiano::layout
