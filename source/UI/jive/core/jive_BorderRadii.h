...
namespace jive {
template <typename Arithmetic> struct BorderRadii {
    ...
    BorderRadii(Arithmetic topLeftAndBottomRight, Arithmetic bottomLeftAndTopRight)
        : BorderRadii {
    ...
    BorderRadii(Arithmetic initialTopLeft, Arithmetic bottomLeftAndTopRight, Arithmetic initialBottomRight)
        : BorderRadii {
            initialTopLeft,
            bottomLeftAndTopRight,
            initialBottomRight,
    ...
    BorderRadii(Arithmetic initialTopLeft, Arithmetic initialTopRight, Arithmetic initialBottomRight,
    ...
    bool operator==(const BorderRadii<Arithmetic>& other) const {
        return juce::approximatelyEqual(topLeft, other.topLeft) && juce::approximatelyEqual(topRight, other.topRight)
...
namespace juce {
template <typename Arithmetic> struct VariantConverter<jive::BorderRadii<Arithmetic>> {
...
template <typename T> String& operator<<(String& str, const jive::BorderRadii<T>& border) {
    return str << "jive::BorderRadii<" << typeid(T).name() << "> { " << border.topLeft << ", " << border.topRight
