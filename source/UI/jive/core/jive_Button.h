...
namespace jive {
class Button : public GuiItemDecorator, private juce::Button::Listener, private juce::ComponentListener {
public:
    enum class TriggerEvent { mouseUp, mouseDown };
...
namespace juce {
template <> class VariantConverter<jive::Button::TriggerEvent> {
public:
