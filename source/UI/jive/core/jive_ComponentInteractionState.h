...
namespace jive {
class ComponentInteractionState : private juce::MouseListener, private juce::FocusChangeListener {
public:
    enum class Mouse {
        dissociate,
        hover,
...
namespace juce {
template <> class VariantConverter<jive::ComponentInteractionState::Mouse> {
public:
...
template <> class VariantConverter<jive::ComponentInteractionState::Keyboard> {
public:
