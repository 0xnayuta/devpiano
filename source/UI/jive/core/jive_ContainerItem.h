...
namespace std {
template <> struct hash<std::pair<juce::Rectangle<float>, jive::LayoutStrategy>> {
    [[nodiscard]] std::size_t
    operator()(const std::pair<juce::Rectangle<float>, jive::LayoutStrategy>& pair) const noexcept {
...
namespace jive {
class ContainerItem : public GuiItemDecorator, private BoxModel::Listener {
public:
    class Child : public GuiItemDecorator, private juce::ComponentListener {
    public:
