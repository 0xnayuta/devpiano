...
const Array<var> VariantConverter<FlexBox::AlignContent>::options
    = { "stretch", "flex-start", "flex-end", "centre", "space-between", "space-around" };
...
const Array<var> VariantConverter<FlexBox::AlignItems>::options = { "stretch", "flex-start", "flex-end", "centre" };
...
const Array<var> VariantConverter<FlexBox::Direction>::options = { "row", "row-reverse", "column", "column-reverse" };
...
const Array<var> VariantConverter<FlexBox::JustifyContent>::options
    = { "flex-start", "flex-end", "centre", "space-between", "space-around" };
...
const Array<var> VariantConverter<FlexBox::Wrap>::options = { "nowrap", "wrap", "wrap-reverse" };
...
const Array<var> VariantConverter<FlexItem::AlignSelf>::options
    = { "auto", "flex-start", "flex-end", "centre", "stretch" };
