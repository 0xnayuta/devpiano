...
namespace juce {
template <> struct VariantConverter<FlexBox::AlignContent> {
...
template <> struct VariantConverter<FlexBox::AlignItems> {
...
template <> struct VariantConverter<FlexBox::Direction> {
...
template <> struct VariantConverter<FlexBox::JustifyContent> {
...
template <> struct VariantConverter<FlexBox::Wrap> {
...
template <> struct VariantConverter<FlexItem::AlignSelf> {
