...
namespace juce {
const Array<var> VariantConverter<GridItem::JustifySelf>::options = { "start", "end", "centre", "stretch", "auto" };
...
const Array<var> VariantConverter<GridItem::AlignSelf>::options = { "start", "end", "centre", "stretch", "auto" };
...
const Array<var> VariantConverter<Grid::JustifyContent>::options = {
    "start", "end", "centre", "stretch", "space-around", "space-between", "space-evenly",
};
