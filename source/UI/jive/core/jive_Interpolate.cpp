...
private:
    ...
    void testStringInterpolation() {
        ...
        expectEquals<juce::String>(jive::interpolate<juce::String>("100", "200", 0.1), "110");

        beginTest("string / non-numeric");
        expectEquals<juce::String>(jive::interpolate<juce::String>("hello", "world", 0.45), "world");
    }

    void testBorderSizeInterpolation() {
        beginTest("border size");
        expectEquals(
            jive::interpolate(juce::BorderSize { 1.0, 2.0, 3.0, 4.0 }, juce::BorderSize { 2.0, 3.0, 4.0, 5.0 }, 0.5),
            juce::BorderSize { 1.5, 2.5, 3.5, 4.5 });

        beginTest("border radii");
        expectEquals(
            jive::interpolate(jive::BorderRadii { 1.0, 2.0, 3.0, 4.0 }, jive::BorderRadii { 2.0, 3.0, 4.0, 5.0 }, 0.5),
    ...
    void testGridTrackInfoInterpolation() {
        ...
        expectEquals(jive::interpolate(juce::Grid::TrackInfo { juce::Grid::Px { 100 } },
                                       juce::Grid::TrackInfo { juce::Grid::Px { 200 } }, 0.3)
                         .getSize(),
        ...
        expectEquals(jive::interpolate(juce::Grid::TrackInfo { juce::Grid::Fr { 1 } },
                                       juce::Grid::TrackInfo { juce::Grid::Fr { 2 } }, 2.0 / 3.0)
                         .getSize(),
                     juce::Grid::TrackInfo { juce::Grid::Fr { 1667 } }.getSize());

        beginTest("grid / track info / different");
        expectEquals(jive::interpolate(juce::Grid::TrackInfo { juce::Grid::Px { 100 } },
                                       juce::Grid::TrackInfo { juce::Grid::Fr { 2 } }, 0.4174)
                         .getSize(),
    ...
    void testColourInterpolation() {
        ...
        beginTest("fill");
        expectEquals(
            jive::interpolate(jive::Fill { juce::Colours::orange }, jive::Fill { juce::Colours::cornflowerblue }, 0.3),
            jive::Fill { juce::Colours::orange.interpolatedWith(juce::Colours::cornflowerblue, 0.3f) });

        expectEquals(jive::interpolate(jive::Fill { jive::Gradient {} }, jive::Fill { juce::Colours::aliceblue }, 0.7),
