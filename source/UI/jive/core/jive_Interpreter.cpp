...
private:
    void testComponentFactory() {
        ...
        interpreter.getComponentFactory().set("MyComponent", []() { return std::make_unique<MyComponent>(); });
        ...
        factory.set("YourComponent", []() { return std::make_unique<YourComponent>(); });
        interpreter.setComponentFactory(factory);
        expect(dynamic_cast<YourComponent*>(interpreter.getComponentFactory().create("YourComponent").get())
               != nullptr);
    }
    ...
    void testNestedComponents() {
        ...
        }
        {
            ...
            expect(view->getChildren()[0]->getComponent()->getNumChildComponents()
                   == tree.getChild(0).getNumChildren());
        }
    }
    ...
    void testDisplayTypes() {
        ...
        expect(dynamic_cast<jive::GuiItemDecorator&>(*basicView).toType<jive::CommonGuiItem>() != nullptr);
        ...
        expect(dynamic_cast<jive::GuiItemDecorator&>(*flexView).toType<jive::FlexContainer>() != nullptr);
        expect(dynamic_cast<jive::GuiItemDecorator&>(*flexView->getChildren()[0]).toType<jive::FlexItem>() != nullptr);
        ...
        expect(dynamic_cast<jive::GuiItemDecorator&>(*gridView).toType<jive::GridContainer>() != nullptr);
        expect(dynamic_cast<jive::GuiItemDecorator&>(*gridView->getChildren()[0]).toType<jive::GridItem>() != nullptr);
        ...
        expect(dynamic_cast<jive::GuiItemDecorator&>(*blockView).toType<jive::BlockContainer>() != nullptr);
        expect(dynamic_cast<jive::GuiItemDecorator&>(*blockView->getChildren()[0]).toType<jive::BlockItem>()
               != nullptr);
    }
    ...
    void testInitialLayout() {
        ...
        expectNotEquals(view->getChildren()[1]->getComponent()->getPosition(), juce::Point<int> {});
    }
    ...
    void testWindowContent() {
        ...
        auto& window = dynamic_cast<jive::GuiItemDecorator&>(*view).toType<jive::Window>()->getWindow();
