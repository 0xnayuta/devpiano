...
private:
    ...
    void testObservations() {
...

        {
            ...
            foo.onValueChange = [&callbackCalled]() { callbackCalled = true; };
        ...
        {
            jive::Property<int, jive::Inheritance::doNotInherit, jive::Accumulation::accumulate> foo { state, "foo" };
        ...
        }
        {
            ...
            const jive::Property<int, jive::Inheritance::doNotInherit, jive::Accumulation::accumulate> value {
                tree, "value"
            };
    ...
    void testDynamicObjectSource() {
        ...
        beginTest("DynamicObject source - standard template args");
        {
            ...
            value.onValueChange = [&receivedCallback]() { receivedCallback = true; };
