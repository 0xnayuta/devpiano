...
using Styles = std::unordered_map<StyleIdentifier,
                                  Property<Value, Inheritance::doNotInherit, Accumulation::doNotAccumulate, false>>;

class StyleSheet : public juce::ReferenceCountedObject, private juce::ComponentListener {
public:
...
private:
    ...
    Property<Object::ReferenceCountedPointer, Inheritance::doNotInherit, Accumulation::doNotAccumulate, false> style;
