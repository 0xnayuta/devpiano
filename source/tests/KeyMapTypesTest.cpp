...
{
public:
    MidiNoteNumberTest() : juce::UnitTest ("MidiNoteNumber", "DevPiano/Core") {}
...
{
public:
    MidiChannelTest() : juce::UnitTest ("MidiChannel", "DevPiano/Core") {}
...
{
public:
    VelocityTest() : juce::UnitTest ("Velocity", "DevPiano/Core") {}
...
{
public:
    NoteRangeTest() : juce::UnitTest ("NoteRange", "DevPiano/Core") {}
...
{
public:
    KeyActionTest() : juce::UnitTest ("KeyAction", "DevPiano/Core") {}
...
{
public:
    KeyBindingTest() : juce::UnitTest ("KeyBinding", "DevPiano/Core") {}
    ...
    void runTest() override
    {
        ...
        testCase ("makeNoteBinding with strong types", [&]
        {
            ...
            auto binding = makeNoteBinding ('D', MidiNoteNumber::fromClamped (50),
                                            MidiChannel::fromClamped (3),
...
{
public:
    DefaultKeyboardLayoutTest() : juce::UnitTest ("DefaultLayout", "DevPiano/Core") {}
    ...
    void runTest() override
    {
        ...
        testCase ("all letter keys have bindings", [&]
        {
            ...
            for (auto c : letters)
            {
                ...
                expect (binding != nullptr,
                        "Missing binding for key '" + juce::String::charToString (c) + "'");
            }
        });
    }
};
...
{
public:
    FullKeyboardLayoutTest() : juce::UnitTest ("FullLayout", "DevPiano/Core") {}
...
{
public:
    MixedCaseKeyLookupTest() : juce::UnitTest ("KeyLookup", "DevPiano/Core") {}
